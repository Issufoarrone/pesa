...
public class MpesaToken {
    ...
    public static void main(String[] args) {
        ...
        context.setApiKey("b3qcy8u9jzpjg8xw6l4sj2y8w6x0057l");
		...
		context.addParameter("input_ThirdPartyReference","Compra de SMS");
		context.addParameter("input_Amount","10");
		context.addParameter("input_CustomerMSISDN","258848101800");
